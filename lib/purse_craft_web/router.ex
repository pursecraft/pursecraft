defmodule PurseCraftWeb.Router do
  ...
  scope "/", PurseCraftWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PurseCraftWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PurseCraftWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PurseCraftWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PurseCraftWeb do
    ...
    live_session :current_user,
      on_mount: [{PurseCraftWeb.UserAuth, :mount_current_user}] do
