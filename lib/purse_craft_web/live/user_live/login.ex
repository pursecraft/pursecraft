    ...
    <Layouts.marketing flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-sm space-y-4">
        ...
        <div :if={local_mail_adapter?()} class="alert alert-info">
          <CoreComponents.icon name="hero-information-circle" class="size-6 shrink-0" />
          <div>
        ...
        >
          ...
          />
          <CoreComponents.button class="btn btn-primary w-full">
        ...
        >
          ...
          />
          <CoreComponents.button class="btn btn-primary w-full" name={@form[:remember_me].name} value="true">
            Log in and stay logged in <span aria-hidden="true">→</span>
          </CoreComponents.button>
          <CoreComponents.button class="btn btn-primary btn-soft w-full mt-2">
